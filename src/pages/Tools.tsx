...
export function Tools() {
    ...
    return (
        <div className="flex flex-col min-h-full">
            ...
            <div className={cn(isFlat ? 'max-w-[1060px] mx-auto w-full px-8 pt-2 pb-10' : 'p-8 pt-6 space-y-6 flex-1 max-w-4xl mx-auto w-full')}>
                {isFlat ? (
                    <>
                        {/* ===== Focus timer + Daily targets ===== */}
                        <div className="grid grid-cols-[1fr_340px] border-b border-[var(--border)]">
                            {/* Focus timer */}
                            <div className="py-6 pr-8">
                                ...
                                <div className="mt-6 flex items-end gap-6">
                                    <div
                                        ...
                                        style={{ fontSize: 118, letterSpacing: '-0.06em' }}
                                    >
                                    ...
                                    <div className="flex gap-2 pb-2">
                                        <button
                                            ...
                                            className="px-3 py-1.5 border border-[var(--foreground)] font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--foreground)] hover:bg-[var(--surface)] transition-colors"
                                        >
                                            {timer.isActive ? 'Pause' : 'Start'}
                                        </button>
                                        <button
                                            onClick={() => dispatch({ type: 'RESET' })}
                                            className="px-3 py-1.5 border border-[var(--border)] font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--muted-foreground)] hover:text-[var(--foreground)] hover:border-[var(--foreground)] transition-colors"
                                        >
                                            Reset
                                        </button>
                                        <button
                                ...
                                {/* Elapsed track */}
                                <div className="mt-5">
                                    <div className="flex justify-between font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--muted-foreground)]">
                                ...
                                <div className="grid grid-cols-4 mt-6 border-t border-[var(--border)]">
                                    {[
                                        ...
                                        <div key={item.label} className={cn('pt-3', i > 0 && 'pl-5 border-l border-[var(--border)]')}>
                                            <div className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">
                                                {item.label}
                                            </div>
                                ...
                                <div className="mt-5 flex items-center gap-2">
                                    ...
                                    <span className="ml-3 font-mono text-[8.5px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">
                            ...
                            {/* Daily targets */}
                            <div className="py-6 pl-8 border-l border-[var(--border)]">
                                <div className="flex items-baseline justify-between">
                                        ...
                                        return (
                                            <div key={goal.id} className="group">
                                                ...
                                                <div className="mt-1.5 flex items-center gap-2">
                                                    ...
                                                    {limit && (
                                                        <span className="font-mono text-[8.5px] uppercase tracking-[0.1em] text-[var(--accent-warning)]">
                                                            LIMIT
                                                        </span>
                                                    )}
                                                    <button
                                                        ...
                                                        className="font-mono text-[9px] text-[var(--muted-foreground)] hover:text-[var(--accent-negative)] transition-colors"
                                                    >
                                                        ×
                                                    </button>
                                                </div>
                                ...
                                <div className="mt-5 flex gap-2 items-center">
                                    <input
                                        ...
                                        className="flex-1 bg-transparent border-b border-dashed border-[var(--border)] focus:border-[var(--foreground)] outline-none font-mono text-[11px] text-[var(--foreground)] py-1.5 placeholder:text-[var(--muted-foreground)]/60"
                                    />
                                    <input
                                        type="number"
                                        ...
                                        className="w-14 bg-transparent border-b border-dashed border-[var(--border)] focus:border-[var(--foreground)] outline-none font-mono text-[11px] text-[var(--foreground)] py-1.5"
                                    />
                                    <span className="font-mono text-[10px] text-[var(--muted-foreground)]">min</span>
                                    <button
                                        onClick={addGoal}
                                ...
                                <p className="text-[10px] text-[var(--muted-foreground)]/70 mt-4 leading-relaxed">
                        ...
                        <div className="py-6 border-b border-[var(--border)]">
                            ...
                            <div className="grid grid-cols-3 gap-10 mt-5">
                                <div>
                                    <div className="flex items-baseline justify-between">
                                        <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">Eye strain</span>
                                        <span className="font-mono text-[11px] font-bold text-[var(--foreground)]">{Math.round(eyeStrainProgress)}%</span>
                                    </div>
                                    <div className="mt-2">
                                        <Bar value={eyeStrainProgress} height="thin" />
                                    </div>
                                    <p className="font-mono text-[8.5px] uppercase tracking-[0.1em] text-[var(--muted-foreground)] mt-2">
                                        Next look-away in {Math.max(0, Math.round(20 * (1 - eyeStrainProgress / 100)))} min
                                    </p>
                                </div>
                                <div>
                                    <div className="flex items-baseline justify-between">
                                        <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">Sedentary</span>
                                        <span className={cn('font-mono text-[11px] font-bold', sedentaryMinutes > 45 ? 'text-[var(--accent-warning)]' : 'text-[var(--foreground)]')}>
                                ...
                                <div>
                                    <div className="flex items-baseline justify-between">
                                        <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">Typing fatigue</span>
                                        <span className="font-mono text-[11px] font-bold text-[var(--foreground)]">{Math.round(typingFatigue)}%</span>
                                    </div>
                                    <div className="mt-2">
                        ...
                        <div className="py-6 border-b border-[var(--border)]">
                            ...
                            <div className="flex items-end gap-8 mt-5">
                                <div className="font-display font-semibold tabular-nums leading-none text-[var(--foreground)]" style={{ fontSize: 56, letterSpacing: '-0.04em' }}>
                                    1:16
                                </div>
                                <div className="flex-1">
                                    ...
                                    <div className="flex justify-between font-mono text-[8.5px] uppercase tracking-[0.1em] text-[var(--muted-foreground)] mt-2">
                                        <span>Inhale 4</span>
                                        <span>Hold 7</span>
                                        <span>Exhale 8</span>
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="px-4 py-1.5 border border-[var(--foreground)] font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--foreground)] hover:bg-[var(--surface)] transition-colors"
                                    >
                                        Start
                                    </button>
                                    <button
                                        onClick={() => setShowBreathing(true)}
                                        className="px-4 py-1.5 border border-[var(--border)] font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--muted-foreground)] hover:text-[var(--foreground)] hover:border-[var(--foreground)] transition-colors"
                                    >
                                        Full screen
                                    </button>
                                </div>
                            </div>
                            <p className="text-[10px] text-[var(--muted-foreground)]/70 mt-4">
                        ...
                        <div className="py-4 flex items-center gap-5">
                            ...
                            <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--muted-foreground)]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <GlassCard className="p-6" hover={false}>
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h3 className="text-lg font-semibold text-[var(--foreground)]">Focus Timer</h3>
                                    <p className="text-xs text-[var(--muted-foreground)]">{timer.mode} · session {timer.workSessions + 1}</p>
                                </div>
                                <SegTabs
                                    options={[
                            ...
                            <div className="flex flex-col items-center">
                                <div className="text-6xl font-display font-bold text-[var(--foreground)] tabular-nums tracking-tight">
                                    {formatClock(timer.timeLeft)}
                                </div>
                                <div className="flex items-center gap-3 mt-5">
                                    <button
                                        onClick={() => dispatch({ type: 'TOGGLE' })}
                                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${timer.isActive ? 'bg-amber-500/20 text-amber-500' : 'bg-[var(--primary)] text-[var(--primary-foreground)]'}`}
                                    >
                                        {timer.isActive ? 'Pause' : 'Start'}
                                    </button>
                                    <button
                                        onClick={() => dispatch({ type: 'RESET' })}
                                        className="px-4 py-2 rounded-lg bg-[var(--secondary)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] text-sm font-medium transition-colors"
                                    >
                                        Reset
                                    </button>
                                    <button
                            ...
                            <div className="mt-6 grid grid-cols-4 gap-4 pt-4 border-t border-[var(--border)]">
                                {[
                                    { label: 'Done today', value: String(timer.workSessions) },
                                    { label: 'Focused', value: formatDuration(focusSeconds) },
                                    { label: 'Breaks', value: String(timer.breaks) },
                                    { label: 'Best streak', value: String(timer.bestStreak) },
                                ].map((item) => (
                                    <div key={item.label}>
                                        <p className="text-[10px] uppercase tracking-wider text-[var(--muted-foreground)]">{item.label}</p>
                                        <p className="font-display text-xl font-bold text-[var(--foreground)] mt-1">{item.value}</p>
                                    </div>
                                ))}
                            </div>
                        </GlassCard>
                        ...
                        <GlassCard className="p-6" hover={false}>
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-semibold text-[var(--foreground)]">Daily Targets</h3>
                                <span className="text-xs text-[var(--muted-foreground)]">{goalsMet} of {goals.length} met</span>
                            </div>
                            <div className="space-y-4">
                                {goals.length === 0 && (
                                    <p className="text-xs text-[var(--muted-foreground)]">No targets yet.</p>
                                )}
                                {goals.map((goal) => {
                                    const used = goalUsage(goal.appName);
                                    return (
                                        <div key={goal.id}>
                                            <div className="flex justify-between text-sm mb-1">
                                                <span className="font-medium text-[var(--foreground)]">{formatAppName(goal.appName)}</span>
                                                <span className="text-xs text-[var(--muted-foreground)]">{used} / {goal.targetMinutes}m</span>
                                            </div>
                                            <div className="w-full bg-[var(--muted)] rounded-full h-1.5 overflow-hidden">
                                                <div
                                                    className="h-full rounded-full bg-emerald-500"
                                                    style={{ width: `${Math.min(100, (used / Math.max(1, goal.targetMinutes)) * 100)}%` }}
                                                />
                                            </div>
                                            <button
                                                onClick={() => removeGoal(goal.id)}
                                                className="text-[10px] text-[var(--muted-foreground)] hover:text-[var(--destructive)] mt-1"
                                            >
                                                remove
                                            </button>
                                        </div>
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                <input
                                    ...
                                    value={newGoalDuration}
                                    onChange={(e) => setNewGoalDuration(e.target.value)}
                                    className="w-16 bg-[var(--background)] border border-[var(--border)] rounded-lg px-2 py-2 text-sm text-[var(--foreground)] outline-none"
                                />
                                <button
                                    onClick={addGoal}
                        ...
                        <GlassCard className="p-6" hover={false}>
                            <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Wellbeing</h3>
                            <div className="space-y-4">
                                <div>
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-[var(--muted-foreground)]">Eye strain</span>
                                        <span className="font-bold text-[var(--foreground)]">{Math.round(eyeStrainProgress)}%</span>
                                    </div>
                                    <div className="w-full bg-[var(--muted)] rounded-full h-1.5 overflow-hidden">
                                        <div className="h-full rounded-full bg-emerald-500" style={{ width: `${eyeStrainProgress}%` }} />
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-[var(--muted-foreground)]">Sedentary</span>
                                        <span className={`font-bold ${sedentaryMinutes > 45 ? 'text-amber-500' : 'text-[var(--foreground)]'}`}>{sedentaryMinutes} min</span>
                                    </div>
                                    <div className="w-full bg-[var(--muted)] rounded-full h-1.5 overflow-hidden">
                                        <div className="h-full rounded-full bg-amber-500" style={{ width: `${(sedentaryMinutes / 60) * 100}%` }} />
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-[var(--muted-foreground)]">Typing fatigue</span>
                                        <span className="font-bold text-[var(--foreground)]">{Math.round(typingFatigue)}%</span>
                                    </div>
                                    <div className="w-full bg-[var(--muted)] rounded-full h-1.5 overflow-hidden">
                                        <div className="h-full rounded-full bg-amber-500" style={{ width: `${typingFatigue}%` }} />
                                    </div>
                                </div>
                            </div>
                        </GlassCard>
                        ...
                        <GlassCard className="p-6 flex flex-col" hover={false}>
                            <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">Breathing</h3>
                            <div className="flex items-center gap-4 flex-1">
                                <div className="text-5xl font-display font-bold text-[var(--foreground)]">1:16</div>
                                <div className="flex-1">
                                    <div className="flex items-end gap-1 h-12">
                                        {[...pattern, ...pattern].map((p, i) => (
                                            <div
                                                key={i}
                                                className={cn('flex-1 rounded-sm', i < 3 ? 'bg-indigo-500/70' : 'bg-[var(--muted)]')}
                                                style={{ height: `${(p.value / maxPattern) * 100}%` }}
                                            />
                                        ))}
                                    </div>
                                    <p className="text-[10px] uppercase tracking-wider text-[var(--muted-foreground)] mt-2 text-center">
                            ...
                            <div className="flex gap-3 mt-5">
                                <button
                                    onClick={() => setShowBreathing(true)}
                                    className="flex-1 py-2 rounded-lg bg-[var(--primary)] text-[var(--primary-foreground)] text-sm font-medium"
                                >
                                    Start
                                </button>
                                <button
                                    onClick={() => setShowBreathing(true)}
                                    className="flex-1 py-2 rounded-lg bg-[var(--secondary)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] text-sm font-medium transition-colors"
                                >
                                    Full screen
                                </button>
                            </div>
